...
class _HomePageState extends State<HomePage> {
  ...
  List<bool> isSelectedInterests = List.generate(30, (_) => false);
  List<bool> isSelectedAccommodation = List.generate(11, (_) => false);

  PickerDateRange? _selectedDateRange;
  final TextEditingController _locationController = TextEditingController();
  final FocusNode _locationFocusNode = FocusNode();
  String _location = '';
  final TextEditingController _tripNoteController = TextEditingController();
  final FocusNode _tripNoteFocusNode = FocusNode();
  String _tripNote = '';
  ...
  void initState() {
    ...
    _tripNoteFocusNode.addListener(_handleTripNoteFocusChange);
  ...
  void dispose() {
    ...
    _tripNoteFocusNode.removeListener(_handleTripNoteFocusChange);
    _tripNoteFocusNode.dispose();
    _tripNoteController.dispose();
    if (_timer.isActive) {
      _timer.cancel();
    }
  ...
  void _handleTripNoteFocusChange() {
    if (!_tripNoteFocusNode.hasFocus) {
      _updateTripNote();
    }
  }
  ...
  void _updateTripNote() {
    setState(() {
      _tripNote = _tripNoteController.text;
    });
  }
    ...
    showDialog(
      ...
      builder: (context) {
        return CustomPurchaseInfoDialog(
          ...
          privacyPolicyUrl: 'https://www.freeprivacypolicy.com/live/468b8da6-685e-47eb-825f-357548d6c6b7',
  ...
  void _resetSelections() {
    setState(() {
      ...
      _location = '';
      _tripNoteController.clear();
      _tripNote = '';
      isSelectedInterests = List.generate(30, (_) => false);
      isSelectedAccommodation = List.generate(11, (_) => false);
      _sliderValue = 0;
    });
  }
  ...
  Widget _buildTripNoteInput() {
    return Padding(
      padding: const EdgeInsets.all(10.0),
      child: TextField(
        controller: _tripNoteController,
        focusNode: _tripNoteFocusNode,
        cursorColor: Colors.black,
        cursorWidth: 1.0,
        decoration: const InputDecoration(
          labelText: 'Describe your trip in one sentence',
          labelStyle: TextStyle(
            color: Color.fromARGB(255, 100, 100, 100),
            fontSize: 14,
          ),
