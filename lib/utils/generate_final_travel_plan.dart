...
Future<List<Map<String, dynamic>>> generateTravelPlan(
  ...
  {bool useFullPlan = true, String tripNote = ''} 
) async {
  ...
  final String tripNoteText = tripNote.trim();
  final String tripContextLine = tripNoteText.isNotEmpty
      ? 'Trip context (optional): $tripNoteText. Prioritize this when planning.'
      : '';
